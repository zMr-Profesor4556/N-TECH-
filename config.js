...
MENU_IMAGE_URL: process.env.MENU_IMAGE_URL || "https://files.catbox.moe/2d7onp.jpg",
// add custom menu and mention reply image url
PREFIX: process.env.PREFIX || ".",
// add your prifix for bot   
BOT_NAME: process.env.BOT_NAME || "N-TECH",
// add bot namw here for menu
STICKER_NAME: process.env.STICKER_NAME || "N-TECH OFFICIAL🇱🇰",
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "94729007640",
// add your bot owner number
OWNER_NAME: process.env.OWNER_NAME || "𝐌𝖗 𝐍𝖎𝖕𝖚𝖓 𝐎𝖋𝖈ᴹᴴᵀ",
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ Akash-MD Official ❣️*",
// add bot owner name    
ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/2d7onp.jpg",
// add img for alive msg
LIVE_MSG: process.env.LIVE_MSG || "> 𝐌𝖗 𝐍𝖎𝖕𝖚𝖓 𝐎𝖋𝖈ᴹᴴᵀ",
// add alive msg here 
...
DEV: process.env.DEV || "94729007640",
